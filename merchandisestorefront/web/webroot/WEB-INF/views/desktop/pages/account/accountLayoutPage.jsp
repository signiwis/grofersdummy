				...
				<c:when test="${orderCancelResult.success}">
					<div class="span-24">
						<div class="information_message positive">
							...
							<p>
								<spring:theme code="order.cancel.success"
									arguments="${orderCancelResult.orderId}" />
							</p>
						</div>
					</div>
				</c:when>
				<c:otherwise>
					<div class="span-24">
						<div class="information_message negative">
							<p>
								<spring:theme code="order.cancel.failed"
									arguments="${orderCancelResult.orderId},${orderCancelResult.failReason}" />
							</p>
						</div>
					</div>
				</c:otherwise>
